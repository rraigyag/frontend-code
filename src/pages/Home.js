...
function Home() {
  ...
  const getTransactions = async () => {
    try {
      ...
      const response = await axios.post(
        'https://om-expenses.onrender.com/api/transactions/get-all-transactions',
        {
          userid: user._id,
          frequency,
  ...
  const deleteTransaction = async (record) => {
    try {
      setLoading(true);
      await axios.post("https://om-expenses.onrender.com/api/transactions/delete-transaction", {
